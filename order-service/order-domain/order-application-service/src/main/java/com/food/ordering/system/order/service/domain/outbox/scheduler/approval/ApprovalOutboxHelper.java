...
public class ApprovalOutboxHelper {
    ...
    public void deleteApprovalOutboxMessageByOutboxStatusAndSagaStatus(OutboxStatus outboxStatus,
                                                                       SagaStatus... sagaStatus) {
        approvalOutboxRepository.deleteByOutboxStatusAndSagaStatus(ORDER_SAGA_NAME, outboxStatus, sagaStatus);
    }
    ...
    private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
        try {
           ...
           throw new OrderDomainException("Could not created OrderApprovalEventPayload for order id: "
