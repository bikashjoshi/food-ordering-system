...
import com.food.ordering.system.payment.source.domain.exception.PaymentDomainException;
...
public class OrderOutboxHelper {
    ...
    public void deleteOrderOutboxMessageByOutboxStatus(OutboxStatus outboxStatus) {
        orderOutboxRepository.deleteByOutboxStatus(ORDER_SAGA_NAME, outboxStatus);
    }
    ...
    @Transactional
    public void updateOutboxMessage(OrderOutboxMessage orderOutboxMessage, OutboxStatus status) {
        orderOutboxMessage.setOutboxStatus(status);
